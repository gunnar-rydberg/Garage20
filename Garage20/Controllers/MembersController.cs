...
namespace Garage20.Controllers
{
    public class MembersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Telephone,Mail")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Telephone,Mail")] Member member)
        {
            if (ModelState.IsValid)
            {
